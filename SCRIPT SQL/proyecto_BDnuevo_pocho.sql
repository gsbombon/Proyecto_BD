/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     26/01/2020 16:38:06                          */
/*==============================================================*/
...
alter table JUGADOR add constraint FK_JUEGA foreign key (EQUI_ID)
...
alter table TABLA_POSICIONES add constraint FK_ORGANIZA foreign key (CAMP_ID)
      references CAMPEONATO (CAMP_ID) on delete restrict on update restrict;
