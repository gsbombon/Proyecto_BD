...
<head>
    <meta charset='utf-8'>
    <title>Modificar Datos Campeonato</title>
    <style type="text/css">
        body {
    ...
    ?>
	 ...
	 echo $fila['CAMP_ID'];
	   ?>
                ...
                <td>
                    <?php
	 echo $fila['CAMP_NOMBRE'];
	   ?>
                </td>
                <td>
                    <?php
	 echo $fila['CAMP_FECHAINICIO'];
	   ?>
                </td>
                <td>
                    <?php
	 echo $fila['CAMP_FECHAFIN'];
	   ?>
                </td>
                <td>
                    <a href="modificar.php?id=<?php echo $fila['CAMP_ID']; ?>">Modificar</a>
                </td>
            </tr>
            <?php
	}
